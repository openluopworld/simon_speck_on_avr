...
.cseg
 ...
 /*
  * Load plain text from RAM to registers.
  * 
  * The low byte of plain text are store in the low register.
  * Plain text:[r7, r6, r5, r4, r3, r2, r1, r0], r7 is the highest byte, r0 is the lowest byte
  */
main:
